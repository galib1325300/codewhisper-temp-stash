...
export default function ShopScrapingPage() {
  const { id } = useParams();
            ...
            <div className="bg-white rounded-lg shadow-sm">
              <div className="p-6 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-semibold text-gray-900">Scraping de boutique</h2>
                  <Button>
              ...
              <div className="p-6">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">
                    Commencez par scraper une boutique concurrente
                  </p>
                  <Button>
